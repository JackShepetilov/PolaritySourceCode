...
def main():
    ...
    e.append('<text x="60" y="62" font-size="12" fill="#666666">'
             'Ландшафт 2017×2017 @100 = 2×2 км; спираль ПРОТИВ часовой; заброс по оси '
             'старт→центр прямо на M1 → 4 мальдивы (2 S + 2 M) → плечо → 3 стража → '
             'цитадель=вилла за гейтом 3/3</text>')
