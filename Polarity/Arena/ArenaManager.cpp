...
{
	// The recipe lives on the point now, so the siege director spawns exactly the same way.
	return SpawnPoint ? SpawnPoint->ResolveSpawnTransformFor(NPCClass) : FTransform::Identity;
}
