...
const FLowHealthDefenseLevelData& UUpgradeDefinition_LowHealthDefense::GetLevelData(int32 Level) const
{
	static const FLowHealthDefenseLevelData FallbackEmpty;
	if (LevelData.Num() == 0)
	{
...
#if WITH_EDITOR
void UUpgradeDefinition_LowHealthDefense::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
